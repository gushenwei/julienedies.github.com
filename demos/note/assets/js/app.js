...
html5sticky.saveNote = function(el){
   if (Modernizr.localstorage){
      ...
      var elem = $('<p class="message"><span>已经保存</span></p>').appendTo('body');
...
$(function(){
    ...
    // save on keyup after 2000 ms
    $('textarea.pedit').live('keyup',function(){
    	var $th = $(this);
    	timer = setTimeout(function(){
    		html5sticky.saveNote( $th );
    	},2000);
    });
    
    // cancel saving action on keypress
    $('textarea.pedit').live('keypress',function(){
    	if(timer){
