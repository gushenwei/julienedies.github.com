var BlobWorld = new (function ()
{
    ...
    function S()
    {
        ...
        {
            a = j[h];
            l.clearRect(a.dirtyRegion.left - 80, a.dirtyRegion.top - 80, a.dirtyRegion.right - a.dirtyRegion.left + 160, 
            a.dirtyRegion.bottom - a.dirtyRegion.top + 160);
            a.dirtyRegion.reset()
        }
        ...
        for (n = j.length; h < n; h++)
        {
            ...
            for (o = a.nodes.length; d < o; d++)
            {
                ...
                {
                    l.quadraticCurveTo(c.position.x, c.position.y, c.position.x + (p.position.x - c.position.x)  / 2, 
                    c.position.y + (p.position.y - c.position.y)  / 2);
                }
            }
            l.stroke();
            l.fill()
    ...
    t, l, j = [], q, I = window.screenX, J = window.screenY, u = g.width * 0.5, v = g.height * 0.5, y = false, 
    F = 0, K = {
        x : 0, y : 1.2
    },
    x = {
    ...
    w = 0, C = [
    {
        fillStyle : "rgba(0,200,250,1.0)", strokeStyle : "#ffffff", lineWidth : 5, backgroundColor : "#222222", 
        debug : false
    },
    {
    ...
    {
        fillStyle : "rgba(0,0,0,0.1)", strokeStyle : "rgba(255,255,255,1.0)", lineWidth : 6, backgroundColor : "#222222", 
        debug : false
    },

    {
        fillStyle : "rgba(255,60,60,1.0)", strokeStyle : "rgba(0,0,0,1.0)", lineWidth : 2, backgroundColor : "#222222", 
        debug : false
    },

    {
        fillStyle : "rgba(255,255,0,1.0)", strokeStyle : "rgba(0,0,0,1.0)", lineWidth : 4, backgroundColor : "#222222", 
        debug : false
    },

    {
        fillStyle : "rgba(255,255,255,1.0)", strokeStyle : "rgba(0,0,0,1.0)", lineWidth : 4, backgroundColor : "#000000", 
        debug : false
    },

    {
        fillStyle : "rgba(0,0,0,1.0)", strokeStyle : "rgba(0,0,0,1.0)", lineWidth : 4, backgroundColor : "#ffffff", 
        debug : false
    }];
    this.init = function ()
    {
